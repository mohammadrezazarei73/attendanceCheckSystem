...
@section('content')
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">لیست دانش آموزان</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                    ...
                                    <tbody>
                                        @foreach($students as $student)
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center"><a href='{{url('/admin/studentClassesList/'.$student->id)}}'><button type="button" class="btn btn-info">لیست</button></a></td>
